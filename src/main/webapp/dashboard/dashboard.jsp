        ...
        <div>
            <div class="brand-logo d-flex align-items-center justify-content-between">
                <a href="./index.html" class="text-nowrap logo-img">
                    <img src="<c:url value="/assets/images/logos/dark-logo.svg"/>" width="180" alt=""/>
                </a>
            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<c:url value="dashboard"/> " aria-expanded="false">
                ...
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="<c:url value=""/> " aria-expanded="false">

                <span>

                    <i class="ti ti-list"></i>
                </span>
                            <span class="hide-menu">List Comics </span>
                        </a>
                    </li>
...
<script src="<c:url value="/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js"/>"></script>
<script src="<c:url value="/assets/js/sidebarmenu.js"/>"></script>
<script src="<c:url value="/assets/js/app.min.js"/>"></script>
<script src="<c:url value="/assets/libs/apexcharts/dist/apexcharts.min.js"/>"></script>
<script src="<c:url value="/assets/libs/simplebar/dist/simplebar.js"/>"></script>
